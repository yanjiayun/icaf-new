 ...
 const Educational= () => {
  ...
  return (
    <div className="mt-24 sm:mt-32 md:mt-36 m-auto max-w-screen-2xl px-8 md:px-12 lg:px-16 xl:px-20">
      ...
      <p className='mb-10 mt-10 xl:mt-8 2xl:mt-6 text-base md:text-xl font-normal text-black font-openSans text-left lg:text-center'>ICAF serves American children as their national art and creativity organization and the world's children as their global art and creativity organization.</p>
      <div className="grid grid-cols-1 gap-y-6 sm:gap-y-8 lg:gap-7 xl:gap-8 2xl:gap-10 lg:grid-cols-4 lg:grid-rows-2">
        <div className="col-span-1 order-1 row-span-1">
          <EducationalCard
            ...
            title= "Pedagogy"
            description= "ICAF has pioneered STEAMS education to integrate art and sports into STEM instruction."
          />
        </div>
        <div className="col-span-1 order-2 lg:order-3 row-span-1">        
          <EducationalCard
            ...
            title= "Advocacy"
            description= "ICAF is the largest child art exhibitor and organizer of youth panels at conferences."
          />
        </div>
