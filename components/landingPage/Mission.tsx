...
const Mission = () => {
  ...
  return (
    <>
      <section className='relative z-50 mt-32 lg:mt-20 mb-48'>
        ...
        <div className='m-auto max-w-screen-2xl px-8 md:px-12 lg:px-16 xl:px-20 grid grid-cols-2 relative'>
          ...
          <div className="relative col-span-2 lg:col-span-1 h-80">
            <div className='mx-auto mt-12 grid grid-cols-3'>
              <div className='flex col-span-1'>
                <AdsClickIcon style={{ color: "#2057CC" }}/>
                <h2 className="ml-5 text-main-blue text-4xl font-semibold font-montserrat">Mission</h2>
              </div>
              <p className="ml-5 col-span-2 text-base text-black font-normal font-openSans">To inspire kids to imagine, create, and care for each other.</p>
              ...
              <p className="mt-10 ml-5 col-span-2 text-base text-black font-normal font-openSans">We envision a world where everyone is creative and kind, achieving success and happiness together.</p>
            </div>
            <img src="/landingPage/missionMapUS.png" alt="Beginner for 2xl devices" className="object-contain object-center absolute left-1/2 -translate-x-1/2 top-10 sm:w-4/5 md:1/2 lg:w-full h-full" />
          ...
          <div className="relative col-span-2 lg:col-span-1 h-80">
            ...
            <img src="/landingPage/missionMapWorld.png" alt="Beginner for 2xl devices" className="object-contain object-center absolute left-1/2 -translate-x-1/2 top-16 lg:top-10 w-full h-full" />
          </div>
        </div>
      </section>
    </>
